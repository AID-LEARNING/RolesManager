...
{
    const ERROR_PLAYER_DISCONNECTED = "Error.player.disconnected";
    ...
    const ADD_PERMISSIONS_TARGET = "Role.target.permission.add";
    const REMOVE_PERMISSIONS_SENDER = "Role.sender.permission.remove";
